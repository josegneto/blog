...
#define EQ            0x1FE609F
#define BUTTON_0      0x1FEE01F     // Rotates key_value * 20 degrees at a time
...
int16_t Speed;     // Number of degrees to move when a left/right button is pressed
...
void setup()
{
  ...
  Speed = 3;               // Moves 3 degrees each time left/right is pushed
